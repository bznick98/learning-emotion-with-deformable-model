...
class Deep_Emotion_FERCKPLUS(nn.Module):
    def __init__(self):
        '''
        Deep_Emotion class contains the network architecture.
        input: Nx48x48x1
        '''
        super().__init__()
        self.conv1 = nn.Conv2d(1,32,3)      # 126x126x32
        self.bn1 = nn.BatchNorm2d(32)     
        self.conv2 = nn.Conv2d(32,32,3)     # 124x124x32
        self.bn2 = nn.BatchNorm2d(32)     
        self.pool2 = nn.MaxPool2d(2,2)      # 62x62x32

        # replace conv3/4 with deformable convolution
        self.de_conv3 = DeformableConv2d(in_channels=10, out_channels=10, kernel_size=3, stride=1, padding=0)
        self.de_conv4 = DeformableConv2d(in_channels=10, out_channels=10, kernel_size=3, stride=1, padding=0)

        self.conv3 = nn.Conv2d(32,64,3)    # 60x60x64
        self.bn3 = nn.BatchNorm2d(64) 
        self.conv4 = nn.Conv2d(64,64,3)    # 58x58x64
        self.bn4 = nn.BatchNorm2d(64)  
        self.pool4 = nn.MaxPool2d(2,2)     # 29x29x64
        ...
        self.flatten = nn.Flatten()
        self.fc1 = nn.Linear(29 * 29 * 64, 50)        # 
        # self.fc1 = nn.Linear(810, 50)        # 
        self.bn_fc = nn.BatchNorm1d(50)
        self.fc2 = nn.Linear(50,7)
